...
ENTS = {6:ENT6, 7:ENT7, 8:ENT8, 9:ENT9}


def getEntGroups(version): #Just because this is useful for my programming
    entenum = ENTS[version]
    pickups = [entenum.I_CLIPS, entenum.I_AMMO, entenum.I_GRENADE, entenum.I_HEALTH, entenum.I_ARMOUR, entenum.I_AKIMBO]
    if version >= 8:
        pickups.append(entenum.I_HELMET)

    teamed = [entenum.PLAYERSTART, entenum.CTF_FLAG]
    static = [entenum.NOTUSED, entenum.LIGHT, entenum.MAPMODEL, entenum.CARROT, entenum.LADDER, entenum.SOUND, entenum.CLIP, entenum.MAXENTTYPES]
    if version >= 7:
        static.append(entenum.PLCLIP)

    return pickups,teamed,static

CubeTypes = utils.enum(
    'SOLID',
    'CORNER',
    'FHF',
    'CHF',
